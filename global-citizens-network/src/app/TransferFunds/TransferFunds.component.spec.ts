...
describe('TransferFundsComponent', () => {
  ...
  let mockTransferFundsService;
  let mockDataService

  beforeEach(async(() => {

    mockTransferFundsService = sinon.createStubInstance(TransferFundsService);
    mockTransferFundsService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: TransferFundsService, useValue: mockTransferFundsService },
